...
public class PrimitiveSpecTokenType extends SpecTokenType {
    ...
    public PrimitiveSpecTokenType(@NotNull List<Party> maintainers, @NotNull UniqueIdentifier uniqueIdentifier, @NotNull String did, @NotNull Double startDl, @NotNull Double endDl, @NotNull Double startUl, @NotNull Double endUl, @NotNull Date startDate, @NotNull Date endDate, @NotNull String duplexMode, @NotNull Integer band, @NotNull String technology, @NotNull String country, String ownerDid, @NotNull String license) {
    ...
    public TokenPointer<PrimitiveSpecTokenType> toPointer(){
        LinearPointer<PrimitiveSpecTokenType> linearPointer = new LinearPointer<>(getLinearId(), PrimitiveSpecTokenType.class);
